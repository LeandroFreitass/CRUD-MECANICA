...
const OrcamentosContextProvider  = (props) => {
...
const updateEmployee = (id, updatedEmployee) => {
    ...
    return (
        <OrcamentosContext.Provider value={{sortedEmployees, addEmployee, deleteEmployee, updateEmployee}}>
            {props.children}
        </OrcamentosContext.Provider>
    )
}

export default OrcamentosContextProvider;