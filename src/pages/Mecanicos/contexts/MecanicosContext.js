...
export const MecanicosContext = createContext()

const MecanicosContextProvider  = (props) => {
...
const updateEmployee = (id, updatedEmployee) => {
    ...
    return (
        <MecanicosContext.Provider value={{sortedEmployees, addEmployee, deleteEmployee, updateEmployee}}>
            {props.children}
        </MecanicosContext.Provider>
    )
}

export default MecanicosContextProvider;