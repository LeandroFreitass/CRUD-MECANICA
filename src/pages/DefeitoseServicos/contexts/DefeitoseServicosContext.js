...
export const DefeitoseServicosContext = createContext()

const DefeitoseServicosContextProvider  = (props) => {
...
const updateEmployee = (id, updatedEmployee) => {
    ...
    return (
        <DefeitoseServicosContext.Provider value={{sortedEmployees, addEmployee, deleteEmployee, updateEmployee}}>
            {props.children}
        </DefeitoseServicosContext.Provider>
    )
}

export default DefeitoseServicosContextProvider;