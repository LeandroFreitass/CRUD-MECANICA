...
const VeiculosContextProvider  = (props) => {
...
const updateEmployee = (id, updatedEmployee) => {
    ...
    return (
        <VeiculosContext.Provider value={{sortedEmployees, addEmployee, deleteEmployee, updateEmployee}}>
            {props.children}
        </VeiculosContext.Provider>
    )
}

export default VeiculosContextProvider;